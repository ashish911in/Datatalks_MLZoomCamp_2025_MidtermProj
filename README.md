...
3. Create Fractional Hour: Combine them into one feature.$$\text{Recorded\_Fractional\_Hour} = \text{recorded\_hour} + \frac{\text{recorded\_minute}}{60} + \frac{\text{recorded\_second}}{3600}$$
